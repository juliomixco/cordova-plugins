...
public class BluetoothPrintService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        ...
        Message msg = mHandler.obtainMessage(WSMPrintService.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(WSMPrintService.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(WSMPrintService.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putInt(WSMPrintService.TOAST, R.string.connect_fail);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(WSMPrintService.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putInt(WSMPrintService.TOAST, R.string.connect_lost);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        ...
        public void run() {
            ...
            while (running) {
                try {
                    ...
                    mHandler.obtainMessage(WSMPrintService.MESSAGE_READ, bytes, -1, rcvData).sendToTarget();
                } catch (IOException e) {
